...
public class TenantServiceTest {
	...
	private List<Tenant> getTenantsMockData() {
		...
		Tenant tenant1 = new Tenant(174L, 45, new FlatAddress());
		Tenant tenant2 = new Tenant(168L, 34, new FlatAddress());
		Tenant tenant3 = new Tenant(172L, 25, new FlatAddress());
		tenants.add(tenant1);
		tenants.add(tenant2);
		tenants.add(tenant3);
		return tenants;
	...
	private Optional<Tenant> getTenantMockData(){
		Tenant tenant = new Tenant(174L, 45, new FlatAddress());
